return {
    ...
    interfaces = {
        { name = "rse_scp_scmi"; protocol = "SCMI"; producer = "rse_runtime"; consumer = "scp_si0"; transport = "MHUv3"; malformed_request = "protocol_error"; recovery = "channel_free_next_request"; purpose = "boot_confirmation_and_ap_primary_power"; scope = "zena_css_architecture" };
        { name = "tfa_scp_scmi"; protocol = "SCMI"; producer = "tfa_bl31"; consumer = "scp_si0"; transport = "MHUv3"; shmem_backing = "ap-mhu-ns"; reset_policy = "preserve_on_ap_reset"; malformed_request = "protocol_error"; recovery = "channel_free_next_request"; purpose = "secondary_cpu_system_power_reset"; scope = "zena_css_architecture" };
        ...
        { name = "ap_pfdi"; protocol = "PFDI"; protocol_id = 0x90; producer = "tfa_bl31"; consumer = "scp_si0"; transport = "SCMI_MHUv3"; channel_count = 16; channel_stride = 40; error_policy = "bounded_timeout"; malformed_request = "protocol_error"; frame_reset = "clear_pending_release_requester"; peer_reset = "no_forward_retry_after_online"; recovery = "channel_free_next_request"; scope = "rd_aspen_cfg2" };
        ...
        { name = "hipc"; protocol = "RPMsg"; producer = "zephyr_si1"; consumer = "linux"; transport = "MHUv3_shared_memory"; reset_policy = "preserve_on_ap_reset"; frame_reset = "clear_pending_release_requester"; peer_reset = "no_forward_retry_after_online"; malformed_descriptor = "bounded_poll_timeout"; recovery = "next_doorbell_retry"; remoteproc_state = "detached"; scope = "fvp_cfg2_extension" };
