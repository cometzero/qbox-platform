...
return {
    ...
    ranges = {
        ...
        { name = "ap_spmc_sdram"; base = 0xFFC00000; size = 0x003FC000; view = "ap"; target = "host_ap_spmc_sdram"; owner = "optee"; access = "secure_rw"; backing = "spmc-sdram"; scope = cfg2; source = guide };
