...
return {
    ...
    ranges = {
        ...
        { name = "ap_watchdog_control"; base = 0x1A430000; size = 0x00010000; view = "ap"; target = "ap_watchdog_control"; owner = "ap"; access = "rw"; scope = architecture; source = guide };
        { name = "ap_secure_watchdog"; base = 0x1A460000; size = 0x00010000; view = "ap"; target = "ap_secure_wdog"; owner = "ap"; access = "secure_rw"; fidelity = "placeholder"; scope = cfg2; source = guide };
        { name = "ap_secure_watchdog_refresh"; base = 0x1A470000; size = 0x00010000; view = "ap"; target = "ap_secure_wdog_refresh"; owner = "ap"; access = "secure_rw"; fidelity = "placeholder"; scope = cfg2; source = guide };
        ...
        { name = "system_ap_mhu_pointer_data"; base = 0xFFFE0000; size = 0x0001C000; view = "system"; target = "host_ap_rse_mailbox"; owner = "rse"; access = "secure_rw"; backing = "ap-rse-carveout"; alias_of = "ap_rse_carveout"; priority = 0; reason = "RSE SFCP pointer access and AP SE-Proxy use one shared carveout backing"; scope = cfg2; source = guide };
        { name = "system_ap_rse_mailbox"; base = 0xFFFFC000; size = 0x00004000; view = "system"; target = "host_ap_rse_mailbox"; owner = "rse"; access = "secure_rw"; backing = "ap-rse-carveout"; alias_of = "ap_rse_carveout"; priority = 0; reason = "The MHU outband mailbox is the final 16 KiB of the AP-RSE carveout"; scope = cfg2; source = guide };
