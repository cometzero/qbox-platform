return {
    ...
    initiators = {
        ...
        { name = "gpex_dma"; domain = "ap"; security = "non_secure"; requester = "gpex0"; stream_id = 0x40; access_kinds = { "b_transport"; "dmi" } };
    ...
    routes = {
        ...
        { name = "pcie_dma_to_smmu"; initiator = "gpex_dma"; from = "ap"; to = "ap"; target = "ap_smmu_0"; path = { "ap_smmu_0.tbu_lti00_socket"; "ap_smmu_0"; "ap_router" }; requester_required = true; stream_id_required = true; fault_signal = "ap_smmu_event" };
