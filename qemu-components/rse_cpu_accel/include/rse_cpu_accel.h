...
private:
    ...
    void write_hotpath_profile_file()
    {
        ...
        out << "{\n"
            ...
            << "    \"watch_count\": " << m_context.pc_entry_watch_count() << ",\n"
            << "    \"watch_add_calls\": " << m_context.pc_entry_watch_add_calls() << ",\n"
            << "    \"watch_clear_calls\": " << m_context.pc_entry_watch_clear_calls() << ",\n"
            << "    \"watch_match_queries\": " << m_context.pc_entry_watch_match_queries() << ",\n"
            << "    \"watch_match_hits\": " << m_context.pc_entry_watch_match_hits() << ",\n"
            << "    \"watch_last_pc\": \"" << hex_string(m_context.pc_entry_watch_last_pc()) << "\",\n"
            << "    \"watch_last_watch_pc\": \"" << hex_string(m_context.pc_entry_watch_last_watch_pc()) << "\",\n"
